...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/transactions/entry": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Parking Entry Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.ParkingEntryRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "requests.ParkingEntryRequest": {
            ...
            "properties": {
                "operator_id": {
                    "description": "OperatorID is the hashed ID of the operator (parking attendant) recording the entry\nIf not provided, it will be extracted from JWT context",
                    "type": "string"
                },
                "plate_number": {
                ...
                "vehicle_type_id": {
                    "description": "VehicleTypeID is the hashed ID of the vehicle type (e.g., \"motorcycle\", \"car\", \"truck\")",
                    "type": "string"
                },
                "zone_id": {
                    "description": "ZoneID is the hashed ID of the parking zone where the vehicle is entering",
                    "type": "string"
                }
            }
        },
